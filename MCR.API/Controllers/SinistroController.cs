...
namespace MCR.API.Controllers
{
    ...
    public class SinistroController : Controller
    {
        ...
        public SinistroController(IPropostasService propostasService)
        {
        ...
        public async Task<IActionResult> Index(int page = 1, int pageSize = 10)
        {
            var request = new ObterPropostasPaginadoRequestDTO
            {
                ...
                {
                    "Comunicar Sinistro", "Sinistro Com Pendência", "Sinistro Aberto/Em Regulação",
                    "Sinistro Aguardando Pagamento", "Sinistro deferido Pago", "Sinistro indeferido", "Sinistro Cancelado"
                }
            };
