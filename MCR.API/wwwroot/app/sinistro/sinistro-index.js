var sinistroIndexJs = {
    ...
    init: function () {
        ...
        $(".btRegistrarOcorrencia").off("click").on("click", function () {
            ...
            sinistroIndexJs.abrirModalOcorrencia(proposta);
        });
    ...
    abrirModalOcorrencia: function (propostaId) {
        ...
        gl.RenderGet("PropostasOcorrenciasRegistrar", "Sinistro", { propostaId: propostaId }, "#modalOcorrencia", true, null, function () {
